...
class LoginResponse :
 ...
 public:
  ...
  // .fixbug.ResultCode another_result = 2;
  bool has_another_result() const;
  private:
  bool _internal_has_another_result() const;
  public:
  void clear_another_result();
  const ::fixbug::ResultCode& another_result() const;
  ::fixbug::ResultCode* release_another_result();
  ::fixbug::ResultCode* mutable_another_result();
  void set_allocated_another_result(::fixbug::ResultCode* another_result);
  private:
  const ::fixbug::ResultCode& _internal_another_result() const;
  ::fixbug::ResultCode* _internal_mutable_another_result();
  public:
 ...
 private:
  ...
  ::fixbug::ResultCode* another_result_;
  bool success_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
// .fixbug.ResultCode another_result = 2;
inline bool LoginResponse::_internal_has_another_result() const {
  return this != internal_default_instance() && another_result_ != nullptr;
}
inline bool LoginResponse::has_another_result() const {
  return _internal_has_another_result();
}
inline void LoginResponse::clear_another_result() {
  if (GetArenaNoVirtual() == nullptr && another_result_ != nullptr) {
    delete another_result_;
  }
  another_result_ = nullptr;
}
inline const ::fixbug::ResultCode& LoginResponse::_internal_another_result() const {
  const ::fixbug::ResultCode* p = another_result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& LoginResponse::another_result() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.another_result)
  return _internal_another_result();
}
inline ::fixbug::ResultCode* LoginResponse::release_another_result() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.another_result)
  
  ::fixbug::ResultCode* temp = another_result_;
  another_result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* LoginResponse::_internal_mutable_another_result() {
  
  if (another_result_ == nullptr) {
    auto* p = CreateMaybeMessage<::fixbug::ResultCode>(GetArenaNoVirtual());
    another_result_ = p;
  }
  return another_result_;
}
inline ::fixbug::ResultCode* LoginResponse::mutable_another_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponse.another_result)
  return _internal_mutable_another_result();
}
inline void LoginResponse::set_allocated_another_result(::fixbug::ResultCode* another_result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete another_result_;
  }
  if (another_result) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      another_result = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, another_result, submessage_arena);
    }
    
  } else {
    
  }
  another_result_ = another_result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginResponse.another_result)
}
