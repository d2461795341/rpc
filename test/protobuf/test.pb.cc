...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginResponse, another_result_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 30, -1, sizeof(::fixbug::GetFriendListRequest)},
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  &descriptor_table_test_2eproto_initialized, descriptor_table_protodef_test_2eproto, "test.proto", 622,
...
void LoginResponse::InitAsDefaultInstance() {
  ...
  ::fixbug::_LoginResponse_default_instance_._instance.get_mutable()->another_result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class LoginResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const LoginResponse* msg);
  static const ::fixbug::ResultCode& another_result(const LoginResponse* msg);
};
...
const ::fixbug::ResultCode&
LoginResponse::_Internal::another_result(const LoginResponse* msg) {
  return *msg->another_result_;
}
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  if (from._internal_has_another_result()) {
    another_result_ = new ::fixbug::ResultCode(*from.another_result_);
  } else {
...
void LoginResponse::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete another_result_;
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ctx->ParseMessage(_internal_mutable_another_result(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // bool success = 3;
...
::PROTOBUF_NAMESPACE_ID::uint8* LoginResponse::_InternalSerialize(
  ...
  // .fixbug.ResultCode another_result = 2;
  if (this->has_another_result()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        2, _Internal::another_result(this), target, stream);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.LoginResponse)
  ...
  if (from.has_another_result()) {
    _internal_mutable_another_result()->::fixbug::ResultCode::MergeFrom(from._internal_another_result());
  }
  if (from.success() != 0) {
...
void LoginResponse::InternalSwap(LoginResponse* other) {
  ...
  swap(another_result_, other->another_result_);
